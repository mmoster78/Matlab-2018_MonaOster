...
% ================================% 
% There's an error in the xlsread code so I can't read in the files. Here
% are my best guesses, without being able to test that what I'm doing is
% correct.
%
...
computer_header=find(strcmp(headers,'computer'));
drinking_header=find(strcmp(headers,'drink'));

figure(4);
set(gcf,'Name', 'Does your computers turn you into a drinker?');
plot([data{:,computer_header}], [data{:, drink_header}], 'ko');
